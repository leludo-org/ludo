...
<svg viewBox="0 0 96 96" class="wc-header-brand-mark" aria-hidden="true">
...
<nav id="header" class="wc-header">
    <a href="/" class="wc-header-brand">
        ${BRAND_MARK}
        <span class="wc-header-wordmark">leludo</span>
    </a>
    <div class="wc-header-actions">
        <wc-settings></wc-settings>
        <a href="https://github.com/LeludoOrg/leludo">
            <svg aria-hidden="true" viewBox="0 0 24 24" class="wc-header-github">
