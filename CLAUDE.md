...
Public release notes live at [docs/changelog.html](docs/changelog.html). Newest entry on top.
...
Play Store listing assets are generated by [scripts/gen-play-store-assets.mjs](scripts/gen-play-store-assets.mjs) into `play-store/` (icon-512, feature-graphic 1024×500, ad banner). Rerun after icon edits.
